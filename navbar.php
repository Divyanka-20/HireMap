...
<nav>
  ...
  <div class="logo-container">
    ...
    <div class="site-info">
      <div class="site-name">Hire Map</div>
    </div>
</div>
</a>
...
<div id="rightSidebar" class="right-sidebar">
  ...
  <a href="<?= isset($_SESSION['user_name']) ? 'experiences.php' : 'login.php' ?>">
    <i class="fas fa-book-open" style="color: #28a745;"></i> Experiences
  </a>
  ...
  <a href="<?= isset($_SESSION['user_name']) ? 'job_listings.php' : 'login.php' ?>">
    <i class="fas fa-briefcase" style="color: #dc3545;"></i> Recent Job Listings
  </a>
  ...
  <a href="faqs.php">
    <i class="fas fa-brain" style="color: #6f42c1;"></i> FAQs About Us
  </a>
  
<?php if (isset($_SESSION['user_name'])): ?>
  <a href="my_experiences.php">
      <i class="fas fa-book" style="color: #28a745; "></i>My Experiences
    </a>
    <a href="logout.php">
